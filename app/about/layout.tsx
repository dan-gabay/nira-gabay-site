...
export const metadata: Metadata = {
  ...
  description:
    'נירה גבאי, מטפלת בפסיכותרפיה ומדריכת הורים. הכשרה ממכון אדלר, התמחות ב-CBT ובמיניות בריאה. מלווה מתבגרים, מבוגרים וזוגות בקליניקה בשואבה, אזור ירושלים.',
  alternates: {
  ...
  openGraph: {
    ...
    description:
      'הכשרה ממכון אדלר, התמחות ב-CBT ובמיניות בריאה. מלווה מתבגרים, מבוגרים וזוגות בדרכם להגשמה עצמית.',
