...
export const metadata: Metadata = {
  title: 'צור קשר',
  description: 'צרו קשר עם נירה גבאי לקביעת פגישה לטיפול פסיכותרפי או הדרכת הורים. הקליניקה ממוקמת במושב שואבה. אפשרות לטיפול בזום.',
  keywords: ['צור קשר', 'קביעת פגישה', 'פסיכותרפיה שואבה', 'טיפול בזום', 'נירה גבאי'],
  openGraph: {
    title: 'צרו קשר עם נירה גבאי - קביעת פגישה',
    description: 'צרו קשר לקביעת פגישה לטיפול פסיכותרפי או הדרכת הורים. הקליניקה במושב שואבה, אפשרות לטיפול בזום.',
  },
};
