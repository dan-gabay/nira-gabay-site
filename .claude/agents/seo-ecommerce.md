...
2. Analyze product pages with `".claude/skills/seo/bin/claude-seo" run render_page.py <URL> --mode auto` and `".claude/skills/seo/bin/claude-seo" run parse_html.py <URL>`
...
4. If DataForSEO credentials available, fetch marketplace data via
   `".claude/skills/seo/bin/claude-seo" run dataforseo_merchant.py`
