...
- **Command:** `".claude/skills/seo/bin/claude-seo" run moz_api.py`
...
- **Command:** `".claude/skills/seo/bin/claude-seo" run bing_webmaster.py`
...
- **Command:** `".claude/skills/seo/bin/claude-seo" run commoncrawl_graph.py`
...
- **Command:** `".claude/skills/seo/bin/claude-seo" run verify_backlinks.py`
